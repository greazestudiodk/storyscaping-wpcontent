 ...
 */
define( 'MARVY_ANIMATION_ADDONS_VERSION', '1.6.1' );
...
function marvy_plugin_settings_link( $links ) {
	$links[] = sprintf( '<a href="admin.php?page=marvy-animation">' . __( 'Settings', 'marvy-lang' ) . '</a>' );
	$links[] = sprintf( '<a href="https://iqonic.design/docs/product/marvy-documentation/getting-started/"  target="_blank">' . __( 'Docs', 'marvy-lang' ) . '</a>' );
	if ( ! isMarvyProInstall() ) {
		$links[] = sprintf( '<a href="https://codecanyon.net/item/marvy-background-animations-for-elementor/28285063" target="_blank" style="font-weight: bold; color: #93003c;">' . __( 'Get Pro', 'marvy-lang' ) . '</a>' );
	}
