...
class OnecomPluginsApi extends WP_REST_Controller {
    ...
    public $ocvmPage = "admin.php?page=onecom-wp-vulnerability-monitor";
    ...
    public function get_health_monitor_action_name( $key, $state = 0 ): array {
        ...
        $item['issue']        = ( ! empty( $category["Critical"] ) && ( 0 === $state || false === array_search( $key, $category["Critical"], true ) ) ) ? 0 : 1;
