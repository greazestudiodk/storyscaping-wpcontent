...
//          // Define other variables
        ...
        public function oc_generate_array($arr=array()){
            ...
            $vulnerability_monitor_page= $this->onecom_vulnerability_monitor_tour();
            ...
            $tours= array (
                ...
                'onecom-wp-vulnerability-monitor-tour' => $vulnerability_monitor_page,
        ...
        public function onecom_health_monitor_tour(){
            return  array (
                ...
                self::BUTTON_2 => __('Next', OC_PLUGIN_DOMAIN),
                self::OC_FUNCTION => 'window.location="' . menu_page_url('onecom-wp-vulnerability-monitor',false) . '"' ,
                self::PARENT => true
            );
        ...
        /**
         * generates parameters array for vulnerability monitor
         */

        public function onecom_vulnerability_monitor_tour(){
            return array (
                'id' => '#onecom_vulnerability_monitor',
                self::CONTENT => self::H3_START .'&nbsp;'. __('Vulnerability Monitor',OC_PLUGIN_DOMAIN) . self::H3_CLOSE
                    . '<p>' . __('Vulnerability Monitor scans and notifies you for potential vulnerabilities present in your active plugins, themes and WordPress core. It also offers to automatically fix the vulnerabilities.',OC_PLUGIN_DOMAIN) . '</p>',
                self::BUTTON_2 => __('Next', OC_PLUGIN_DOMAIN),
