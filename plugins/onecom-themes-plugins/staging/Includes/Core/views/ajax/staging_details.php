                        ...
                        <div class="entry-name">
                            ...
                            <?php if($cloneExists): ?>
                                <div class="entry-link stg_info">
                                    <p>
                                        <span><a href="javascript:void(0);" data-loginUrl="<?php echo trailingslashit($clone['url']); ?>wp-login.php" data-stgUrl="<?php echo trailingslashit($clone['url']); ?>" class="one-button btn button_1 loginStaging" style="line-height: 16px;min-width: 62px;text-align: center;margin-right: 30px;"><?php _e( 'Login', OC_PLUGIN_DOMAIN ); ?></a></span>
                                        <span><a href="<?php echo $clone['url']; ?>" target="_blank" class="viewStaging"><?php _e( 'View site', OC_PLUGIN_DOMAIN ); ?></a></span>
                                    </p>
                                </div>
                            <?php else: ?>
                                <div>
