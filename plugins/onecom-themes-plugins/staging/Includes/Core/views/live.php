               ...
               <?php
                ...
                <?php endif; ?>
                        ...
                        <div class="one-card-staging-create-info">
                            <h2 class="no-top-margin"><?php _e( 'Create staging site', OC_PLUGIN_DOMAIN ); ?></h2>
		                    <?php _e( 'The staging environment allows you to make changes to your site, without it affecting the live version of your website. When you create a staging site, it will be a snapshot of your live website.' , OC_PLUGIN_DOMAIN );?><br><?php _e( 'You can use it as a playground to test new plugins and themes. Once you are satisfied with the result, you can copy all the changes to your live website with a single click.' , OC_PLUGIN_DOMAIN ); ?>
                            <p>
